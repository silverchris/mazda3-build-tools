...
namespace DBus {
  ...
  class InterfaceProxy
  {
    ...
    public:
      ...
      {
        DBusCxxPointer< MethodProxy<T_return> > method;
        method = MethodProxy<T_return>::create(name);
      ...
      {
        DBusCxxPointer< MethodProxy<T_return, T_arg1> > method;
        method = MethodProxy<T_return, T_arg1>::create(name);
        this->add_method(method);
        return method;
      }
      ...
      {
        DBusCxxPointer< MethodProxy<T_return, T_arg1,T_arg2> > method;
        method = MethodProxy<T_return, T_arg1,T_arg2>::create(name);
        this->add_method(method);
        return method;
      }
      ...
      {
        DBusCxxPointer< MethodProxy<T_return, T_arg1,T_arg2,T_arg3> > method;
        method = MethodProxy<T_return, T_arg1,T_arg2,T_arg3>::create(name);
        this->add_method(method);
        return method;
      }
      ...
      {
        DBusCxxPointer< MethodProxy<T_return, T_arg1,T_arg2,T_arg3,T_arg4> > method;
        method = MethodProxy<T_return, T_arg1,T_arg2,T_arg3,T_arg4>::create(name);
        this->add_method(method);
        return method;
      }
      ...
      {
        DBusCxxPointer< MethodProxy<T_return, T_arg1,T_arg2,T_arg3,T_arg4,T_arg5> > method;
        method = MethodProxy<T_return, T_arg1,T_arg2,T_arg3,T_arg4,T_arg5>::create(name);
        this->add_method(method);
        return method;
      }
      ...
      {
        DBusCxxPointer< MethodProxy<T_return, T_arg1,T_arg2,T_arg3,T_arg4,T_arg5,T_arg6> > method;
        method = MethodProxy<T_return, T_arg1,T_arg2,T_arg3,T_arg4,T_arg5,T_arg6>::create(name);
        this->add_method(method);
        return method;
      }
      ...
      DBusCxxPointer<signal_proxy<T_return> > create_signal( const std::string& sig_name )
      {
        ...
        sig = signal_proxy<T_return>::create(this->path(), m_name, sig_name);
        this->add_signal(sig);
        return sig;
      }
      ...
      DBusCxxPointer<signal_proxy<T_return, T_arg1> > create_signal( const std::string& sig_name )
      {
        ...
        sig = signal_proxy<T_return, T_arg1>::create(this->path(), m_name, sig_name);
        this->add_signal(sig);
        return sig;
      }
      ...
      DBusCxxPointer<signal_proxy<T_return, T_arg1,T_arg2> > create_signal( const std::string& sig_name )
      {
        ...
        sig = signal_proxy<T_return, T_arg1,T_arg2>::create(this->path(), m_name, sig_name);
        this->add_signal(sig);
        return sig;
      }
      ...
      DBusCxxPointer<signal_proxy<T_return, T_arg1,T_arg2,T_arg3> > create_signal( const std::string& sig_name )
      {
        ...
        sig = signal_proxy<T_return, T_arg1,T_arg2,T_arg3>::create(this->path(), m_name, sig_name);
        this->add_signal(sig);
        return sig;
      }
      ...
      DBusCxxPointer<signal_proxy<T_return, T_arg1,T_arg2,T_arg3,T_arg4> > create_signal( const std::string& sig_name )
      {
        ...
        sig = signal_proxy<T_return, T_arg1,T_arg2,T_arg3,T_arg4>::create(this->path(), m_name, sig_name);
        this->add_signal(sig);
        return sig;
      }
      ...
      DBusCxxPointer<signal_proxy<T_return, T_arg1,T_arg2,T_arg3,T_arg4,T_arg5> > create_signal( const std::string& sig_name )
      {
        ...
        sig = signal_proxy<T_return, T_arg1,T_arg2,T_arg3,T_arg4,T_arg5>::create(this->path(), m_name, sig_name);
        this->add_signal(sig);
        return sig;
      }
      ...
      DBusCxxPointer<signal_proxy<T_return, T_arg1,T_arg2,T_arg3,T_arg4,T_arg5,T_arg6> > create_signal( const std::string& sig_name )
      {
        ...
        sig = signal_proxy<T_return, T_arg1,T_arg2,T_arg3,T_arg4,T_arg5,T_arg6>::create(this->path(), m_name, sig_name);
        this->add_signal(sig);
        return sig;
      }
